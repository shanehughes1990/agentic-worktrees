...
class Variables$Query$Workers {
  factory Variables$Query$Workers({required int limit}) =>
      Variables$Query$Workers._({r'limit': limit});

  Variables$Query$Workers._(this._$data);

  factory Variables$Query$Workers.fromJson(Map<String, dynamic> data) {
    final result$data = <String, dynamic>{};
    final l$limit = data['limit'];
    result$data['limit'] = (l$limit as int);
    return Variables$Query$Workers._(result$data);
  }
  ...
  CopyWith$Variables$Query$Workers<Variables$Query$Workers> get copyWith =>
      CopyWith$Variables$Query$Workers(this, (i) => i);
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Variables$Query$Workers || runtimeType != other.runtimeType) {
      return false;
    }
    final l$limit = limit;
    final lOther$limit = other.limit;
...
abstract class CopyWith$Variables$Query$Workers<TRes> {
  factory CopyWith$Variables$Query$Workers(
    Variables$Query$Workers instance,
    TRes Function(Variables$Query$Workers) then,
  ) = _CopyWithImpl$Variables$Query$Workers;

  factory CopyWith$Variables$Query$Workers.stub(TRes res) =
      _CopyWithStubImpl$Variables$Query$Workers;

  TRes call({int? limit});
}

class _CopyWithImpl$Variables$Query$Workers<TRes>
    implements CopyWith$Variables$Query$Workers<TRes> {
  _CopyWithImpl$Variables$Query$Workers(this._instance, this._then);

  final Variables$Query$Workers _instance;

  final TRes Function(Variables$Query$Workers) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({Object? limit = _undefined}) => _then(
    Variables$Query$Workers._({
      ..._instance._$data,
      if (limit != _undefined && limit != null) 'limit': (limit as int),
    }),
  );
...
class _CopyWithStubImpl$Variables$Query$Workers<TRes>
    implements CopyWith$Variables$Query$Workers<TRes> {
  _CopyWithStubImpl$Variables$Query$Workers(this._res);
...
class Query$Workers {
  Query$Workers({required this.workers, this.$__typename = 'Query'});

  factory Query$Workers.fromJson(Map<String, dynamic> json) {
    final l$workers = json['workers'];
    final l$$__typename = json['__typename'];
    return Query$Workers(
      workers: Query$Workers$workers.fromJson(
        (l$workers as Map<String, dynamic>),
      ),
      $__typename: (l$$__typename as String),
    );
  }

  final Query$Workers$workers workers;

  final String $__typename;

  Map<String, dynamic> toJson() {
    final _resultData = <String, dynamic>{};
    final l$workers = workers;
    _resultData['workers'] = l$workers.toJson();
    final l$$__typename = $__typename;
    _resultData['__typename'] = l$$__typename;
    return _resultData;
  }
  ...
  int get hashCode {
    final l$workers = workers;
    final l$$__typename = $__typename;
    return Object.hashAll([l$workers, l$$__typename]);
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$Workers || runtimeType != other.runtimeType) {
      return false;
    }
    final l$workers = workers;
    final lOther$workers = other.workers;
    if (l$workers != lOther$workers) {
      return false;
    }
    final l$$__typename = $__typename;
    final lOther$$__typename = other.$__typename;
...
extension UtilityExtension$Query$Workers on Query$Workers {
  CopyWith$Query$Workers<Query$Workers> get copyWith =>
      CopyWith$Query$Workers(this, (i) => i);
}

abstract class CopyWith$Query$Workers<TRes> {
  factory CopyWith$Query$Workers(
    Query$Workers instance,
    TRes Function(Query$Workers) then,
  ) = _CopyWithImpl$Query$Workers;

  factory CopyWith$Query$Workers.stub(TRes res) =
      _CopyWithStubImpl$Query$Workers;

  TRes call({Query$Workers$workers? workers, String? $__typename});
  CopyWith$Query$Workers$workers<TRes> get workers;
}

class _CopyWithImpl$Query$Workers<TRes>
    implements CopyWith$Query$Workers<TRes> {
  _CopyWithImpl$Query$Workers(this._instance, this._then);

  final Query$Workers _instance;

  final TRes Function(Query$Workers) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({Object? workers = _undefined, Object? $__typename = _undefined}) =>
      _then(
        Query$Workers(
          workers: workers == _undefined || workers == null
              ? _instance.workers
              : (workers as Query$Workers$workers),
          $__typename: $__typename == _undefined || $__typename == null
              ? _instance.$__typename
              : ($__typename as String),
        ),
  ...
  CopyWith$Query$Workers$workers<TRes> get workers {
    final local$workers = _instance.workers;
    return CopyWith$Query$Workers$workers(
      local$workers,
      (e) => call(workers: e),
    );
  }
...
class _CopyWithStubImpl$Query$Workers<TRes>
    implements CopyWith$Query$Workers<TRes> {
  _CopyWithStubImpl$Query$Workers(this._res);

  TRes _res;

  call({Query$Workers$workers? workers, String? $__typename}) => _res;

  CopyWith$Query$Workers$workers<TRes> get workers =>
      CopyWith$Query$Workers$workers.stub(_res);
}

const documentNodeQueryWorkers = DocumentNode(
  definitions: [
    OperationDefinitionNode(
      type: OperationType.query,
      name: NameNode(value: 'Workers'),
      variableDefinitions: [
        VariableDefinitionNode(
          variable: VariableNode(name: NameNode(value: 'limit')),
          type: NamedTypeNode(name: NameNode(value: 'Int'), isNonNull: true),
            ...
            selectionSet: SelectionSetNode(
              selections: [
                ...
                InlineFragmentNode(
                  typeCondition: TypeConditionNode(
                    on: NamedTypeNode(
                      name: NameNode(value: 'WorkersSuccess'),
                      isNonNull: false,
                    ),
                  ),
                  directives: [],
                      ...
                      FieldNode(
                        ...
                        selectionSet: SelectionSetNode(
                          selections: [
                            ...
                            FieldNode(
                              name: NameNode(value: 'lastHeartbeat'),
                              alias: null,
                              arguments: [],
                              directives: [],
                              selectionSet: null,
...
Query$Workers _parserFn$Query$Workers(Map<String, dynamic> data) =>
    Query$Workers.fromJson(data);
typedef OnQueryComplete$Query$Workers =
    FutureOr<void> Function(Map<String, dynamic>?, Query$Workers?);

class Options$Query$Workers extends graphql.QueryOptions<Query$Workers> {
  Options$Query$Workers({
    String? operationName,
    required Variables$Query$Workers variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    Query$Workers? typedOptimisticResult,
    Duration? pollInterval,
    graphql.Context? context,
    OnQueryComplete$Query$Workers? onComplete,
    graphql.OnQueryError? onError,
  }) : onCompleteWithParsed = onComplete,
       super(
         variables: variables.toJson(),
         ...
         onComplete: onComplete == null
             ...
             : (data) => onComplete(
                 data,
                 data == null ? null : _parserFn$Query$Workers(data),
               ),
         onError: onError,
         document: documentNodeQueryWorkers,
         parserFn: _parserFn$Query$Workers,
       );

  final OnQueryComplete$Query$Workers? onCompleteWithParsed;
...
class WatchOptions$Query$Workers
    extends graphql.WatchQueryOptions<Query$Workers> {
  WatchOptions$Query$Workers({
    String? operationName,
    required Variables$Query$Workers variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
...
class FetchMoreOptions$Query$Workers extends graphql.FetchMoreOptions {
  FetchMoreOptions$Query$Workers({
    required graphql.UpdateQuery updateQuery,
    required Variables$Query$Workers variables,
  }) : super(
         updateQuery: updateQuery,
...
extension ClientExtension$Query$Workers on graphql.GraphQLClient {
  Future<graphql.QueryResult<Query$Workers>> query$Workers(
    Options$Query$Workers options,
  ) async => await this.query(options);

  graphql.ObservableQuery<Query$Workers> watchQuery$Workers(
    WatchOptions$Query$Workers options,
  ) => this.watchQuery(options);

  void writeQuery$Workers({
    required Query$Workers data,
    required Variables$Query$Workers variables,
    bool broadcast = true,
  }) => this.writeQuery(
    graphql.Request(
      operation: graphql.Operation(document: documentNodeQueryWorkers),
      variables: variables.toJson(),
    ),
    data: data.toJson(),
    broadcast: broadcast,
  ...
  Query$Workers? readQuery$Workers({
    required Variables$Query$Workers variables,
    bool optimistic = true,
  }) {
    final result = this.readQuery(
    ...
    return result == null ? null : Query$Workers.fromJson(result);
  }
}

class Query$Workers$workers {
  Query$Workers$workers({required this.$__typename});

  factory Query$Workers$workers.fromJson(Map<String, dynamic> json) {
    switch (json["__typename"] as String) {
      case "WorkersSuccess":
        return Query$Workers$workers$$WorkersSuccess.fromJson(json);

      case "GraphError":
        return Query$Workers$workers$$GraphError.fromJson(json);

      default:
        final l$$__typename = json['__typename'];
        return Query$Workers$workers($__typename: (l$$__typename as String));
    }
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$Workers$workers || runtimeType != other.runtimeType) {
      return false;
    }
    final l$$__typename = $__typename;
    final lOther$$__typename = other.$__typename;
...
extension UtilityExtension$Query$Workers$workers on Query$Workers$workers {
  CopyWith$Query$Workers$workers<Query$Workers$workers> get copyWith =>
      CopyWith$Query$Workers$workers(this, (i) => i);

  _T when<_T>({
    required _T Function(Query$Workers$workers$$WorkersSuccess) workersSuccess,
    required _T Function(Query$Workers$workers$$GraphError) graphError,
    required _T Function() orElse,
  }) {
    switch ($__typename) {
      case "WorkersSuccess":
        return workersSuccess(this as Query$Workers$workers$$WorkersSuccess);

      case "GraphError":
        return graphError(this as Query$Workers$workers$$GraphError);
  ...
  _T maybeWhen<_T>({
    _T Function(Query$Workers$workers$$WorkersSuccess)? workersSuccess,
    _T Function(Query$Workers$workers$$GraphError)? graphError,
    required _T Function() orElse,
  }) {
    switch ($__typename) {
      case "WorkersSuccess":
        if (workersSuccess != null) {
          return workersSuccess(this as Query$Workers$workers$$WorkersSuccess);
        } else {
          return orElse();
        }
...
abstract class CopyWith$Query$Workers$workers<TRes> {
  factory CopyWith$Query$Workers$workers(
    Query$Workers$workers instance,
    TRes Function(Query$Workers$workers) then,
  ) = _CopyWithImpl$Query$Workers$workers;

  factory CopyWith$Query$Workers$workers.stub(TRes res) =
      _CopyWithStubImpl$Query$Workers$workers;

  TRes call({String? $__typename});
}

class _CopyWithImpl$Query$Workers$workers<TRes>
    implements CopyWith$Query$Workers$workers<TRes> {
  _CopyWithImpl$Query$Workers$workers(this._instance, this._then);

  final Query$Workers$workers _instance;

  final TRes Function(Query$Workers$workers) _then;
...
class _CopyWithStubImpl$Query$Workers$workers<TRes>
    implements CopyWith$Query$Workers$workers<TRes> {
  _CopyWithStubImpl$Query$Workers$workers(this._res);
...
class Query$Workers$workers$$WorkersSuccess implements Query$Workers$workers {
  Query$Workers$workers$$WorkersSuccess({
    required this.workers,
    this.$__typename = 'WorkersSuccess',
  });

  factory Query$Workers$workers$$WorkersSuccess.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$workers = json['workers'];
    final l$$__typename = json['__typename'];
    return Query$Workers$workers$$WorkersSuccess(
      workers: (l$workers as List<dynamic>)
          .map(
            (e) => Query$Workers$workers$$WorkersSuccess$workers.fromJson(
              (e as Map<String, dynamic>),
            ),
          )
          .toList(),
  ...
  final List<Query$Workers$workers$$WorkersSuccess$workers> workers;
  ...
  Map<String, dynamic> toJson() {
    final _resultData = <String, dynamic>{};
    final l$workers = workers;
    _resultData['workers'] = l$workers.map((e) => e.toJson()).toList();
    final l$$__typename = $__typename;
    _resultData['__typename'] = l$$__typename;
    return _resultData;
  }
  ...
  int get hashCode {
    ...
    final l$$__typename = $__typename;
    return Object.hashAll([
      Object.hashAll(l$workers.map((v) => v)),
      l$$__typename,
    ]);
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$Workers$workers$$WorkersSuccess ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$workers = workers;
    final lOther$workers = other.workers;
    if (l$workers.length != lOther$workers.length) {
      return false;
    }
    for (int i = 0; i < l$workers.length; i++) {
      final l$workers$entry = l$workers[i];
      final lOther$workers$entry = lOther$workers[i];
      if (l$workers$entry != lOther$workers$entry) {
        return false;
      }
    }
    final l$$__typename = $__typename;
...
extension UtilityExtension$Query$Workers$workers$$WorkersSuccess
    on Query$Workers$workers$$WorkersSuccess {
  CopyWith$Query$Workers$workers$$WorkersSuccess<
    Query$Workers$workers$$WorkersSuccess
  >
  get copyWith =>
      CopyWith$Query$Workers$workers$$WorkersSuccess(this, (i) => i);
}

abstract class CopyWith$Query$Workers$workers$$WorkersSuccess<TRes> {
  factory CopyWith$Query$Workers$workers$$WorkersSuccess(
    Query$Workers$workers$$WorkersSuccess instance,
    TRes Function(Query$Workers$workers$$WorkersSuccess) then,
  ) = _CopyWithImpl$Query$Workers$workers$$WorkersSuccess;

  factory CopyWith$Query$Workers$workers$$WorkersSuccess.stub(TRes res) =
      _CopyWithStubImpl$Query$Workers$workers$$WorkersSuccess;

  TRes call({
    List<Query$Workers$workers$$WorkersSuccess$workers>? workers,
    String? $__typename,
  });
  TRes workers(
    Iterable<Query$Workers$workers$$WorkersSuccess$workers> Function(
      Iterable<
        CopyWith$Query$Workers$workers$$WorkersSuccess$workers<
          Query$Workers$workers$$WorkersSuccess$workers
        >
      >,
    )
    _fn,
...
class _CopyWithImpl$Query$Workers$workers$$WorkersSuccess<TRes>
    implements CopyWith$Query$Workers$workers$$WorkersSuccess<TRes> {
  _CopyWithImpl$Query$Workers$workers$$WorkersSuccess(
    this._instance,
    this._then,
  );

  final Query$Workers$workers$$WorkersSuccess _instance;

  final TRes Function(Query$Workers$workers$$WorkersSuccess) _then;
      ...
      _then(
        Query$Workers$workers$$WorkersSuccess(
          workers: workers == _undefined || workers == null
              ? _instance.workers
              : (workers
                    as List<Query$Workers$workers$$WorkersSuccess$workers>),
          $__typename: $__typename == _undefined || $__typename == null
              ? _instance.$__typename
              : ($__typename as String),
        ),
  ...
  TRes workers(
    ...
    workers: _fn(
      _instance.workers.map(
        (e) =>
            CopyWith$Query$Workers$workers$$WorkersSuccess$workers(e, (i) => i),
      ),
    ).toList(),
  );
}

class _CopyWithStubImpl$Query$Workers$workers$$WorkersSuccess<TRes>
    implements CopyWith$Query$Workers$workers$$WorkersSuccess<TRes> {
  _CopyWithStubImpl$Query$Workers$workers$$WorkersSuccess(this._res);
...
class Query$Workers$workers$$WorkersSuccess$workers {
  Query$Workers$workers$$WorkersSuccess$workers({
    required this.workerID,
    required this.capabilities,
    required this.lastHeartbeat,
    this.$__typename = 'WorkerSummary',
  });

  factory Query$Workers$workers$$WorkersSuccess$workers.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$workerID = json['workerID'];
    final l$capabilities = json['capabilities'];
    final l$lastHeartbeat = json['lastHeartbeat'];
    final l$$__typename = json['__typename'];
    return Query$Workers$workers$$WorkersSuccess$workers(
      workerID: (l$workerID as String),
      capabilities: (l$capabilities as List<dynamic>)
          .map((e) => fromJson$Enum$JobKind((e as String)))
          .toList(),
      lastHeartbeat: dateTimeFromJson(l$lastHeartbeat),
      $__typename: (l$$__typename as String),
    );
  }
  ...
  final List<Enum$JobKind> capabilities;
  ...
  Map<String, dynamic> toJson() {
    final _resultData = <String, dynamic>{};
    final l$workerID = workerID;
    _resultData['workerID'] = l$workerID;
    final l$capabilities = capabilities;
    _resultData['capabilities'] = l$capabilities
        .map((e) => toJson$Enum$JobKind(e))
        .toList();
    final l$lastHeartbeat = lastHeartbeat;
    _resultData['lastHeartbeat'] = dateTimeToJson(l$lastHeartbeat);
    final l$$__typename = $__typename;
    _resultData['__typename'] = l$$__typename;
    return _resultData;
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$Workers$workers$$WorkersSuccess$workers ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$workerID = workerID;
    final lOther$workerID = other.workerID;
    if (l$workerID != lOther$workerID) {
      return false;
    }
    final l$capabilities = capabilities;
    ...
    final l$lastHeartbeat = lastHeartbeat;
    final lOther$lastHeartbeat = other.lastHeartbeat;
    if (l$lastHeartbeat != lOther$lastHeartbeat) {
      return false;
    }
    final l$$__typename = $__typename;
    final lOther$$__typename = other.$__typename;
...
extension UtilityExtension$Query$Workers$workers$$WorkersSuccess$workers
    on Query$Workers$workers$$WorkersSuccess$workers {
  CopyWith$Query$Workers$workers$$WorkersSuccess$workers<
    Query$Workers$workers$$WorkersSuccess$workers
  >
  get copyWith =>
      CopyWith$Query$Workers$workers$$WorkersSuccess$workers(this, (i) => i);
}

abstract class CopyWith$Query$Workers$workers$$WorkersSuccess$workers<TRes> {
  factory CopyWith$Query$Workers$workers$$WorkersSuccess$workers(
    Query$Workers$workers$$WorkersSuccess$workers instance,
    TRes Function(Query$Workers$workers$$WorkersSuccess$workers) then,
  ) = _CopyWithImpl$Query$Workers$workers$$WorkersSuccess$workers;

  factory CopyWith$Query$Workers$workers$$WorkersSuccess$workers.stub(
    TRes res,
  ) = _CopyWithStubImpl$Query$Workers$workers$$WorkersSuccess$workers;

  TRes call({
    String? workerID,
    List<Enum$JobKind>? capabilities,
    DateTime? lastHeartbeat,
    String? $__typename,
  });
}

class _CopyWithImpl$Query$Workers$workers$$WorkersSuccess$workers<TRes>
    implements CopyWith$Query$Workers$workers$$WorkersSuccess$workers<TRes> {
  _CopyWithImpl$Query$Workers$workers$$WorkersSuccess$workers(
    this._instance,
    this._then,
  );

  final Query$Workers$workers$$WorkersSuccess$workers _instance;

  final TRes Function(Query$Workers$workers$$WorkersSuccess$workers) _then;
  ...
  TRes call({
    ...
    Query$Workers$workers$$WorkersSuccess$workers(
      workerID: workerID == _undefined || workerID == null
          ? _instance.workerID
          : (workerID as String),
      capabilities: capabilities == _undefined || capabilities == null
          ? _instance.capabilities
          : (capabilities as List<Enum$JobKind>),
      lastHeartbeat: lastHeartbeat == _undefined || lastHeartbeat == null
          ? _instance.lastHeartbeat
...
class _CopyWithStubImpl$Query$Workers$workers$$WorkersSuccess$workers<TRes>
    implements CopyWith$Query$Workers$workers$$WorkersSuccess$workers<TRes> {
  _CopyWithStubImpl$Query$Workers$workers$$WorkersSuccess$workers(this._res);
...
class Query$Workers$workers$$GraphError implements Query$Workers$workers {
  Query$Workers$workers$$GraphError({
    required this.code,
    required this.message,
    this.field,
    this.$__typename = 'GraphError',
  ...
  factory Query$Workers$workers$$GraphError.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$code = json['code'];
    final l$message = json['message'];
    final l$field = json['field'];
    final l$$__typename = json['__typename'];
    return Query$Workers$workers$$GraphError(
      code: fromJson$Enum$GraphErrorCode((l$code as String)),
      message: (l$message as String),
      field: (l$field as String?),
      $__typename: (l$$__typename as String),
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Query$Workers$workers$$GraphError ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$code = code;
...
extension UtilityExtension$Query$Workers$workers$$GraphError
    on Query$Workers$workers$$GraphError {
  CopyWith$Query$Workers$workers$$GraphError<Query$Workers$workers$$GraphError>
  get copyWith => CopyWith$Query$Workers$workers$$GraphError(this, (i) => i);
}

abstract class CopyWith$Query$Workers$workers$$GraphError<TRes> {
  factory CopyWith$Query$Workers$workers$$GraphError(
    Query$Workers$workers$$GraphError instance,
    TRes Function(Query$Workers$workers$$GraphError) then,
  ) = _CopyWithImpl$Query$Workers$workers$$GraphError;

  factory CopyWith$Query$Workers$workers$$GraphError.stub(TRes res) =
      _CopyWithStubImpl$Query$Workers$workers$$GraphError;
...
class _CopyWithImpl$Query$Workers$workers$$GraphError<TRes>
    implements CopyWith$Query$Workers$workers$$GraphError<TRes> {
  _CopyWithImpl$Query$Workers$workers$$GraphError(this._instance, this._then);

  final Query$Workers$workers$$GraphError _instance;

  final TRes Function(Query$Workers$workers$$GraphError) _then;
...
class _CopyWithStubImpl$Query$Workers$workers$$GraphError<TRes>
    implements CopyWith$Query$Workers$workers$$GraphError<TRes> {
  _CopyWithStubImpl$Query$Workers$workers$$GraphError(this._res);
...
class Variables$Mutation$EnqueueScmWorkflow {
  factory Variables$Mutation$EnqueueScmWorkflow({
    required Input$EnqueueSCMWorkflowInput input,
  }) => Variables$Mutation$EnqueueScmWorkflow._({r'input': input});

  Variables$Mutation$EnqueueScmWorkflow._(this._$data);

  factory Variables$Mutation$EnqueueScmWorkflow.fromJson(
    Map<String, dynamic> data,
  ) {
    final result$data = <String, dynamic>{};
    final l$input = data['input'];
    result$data['input'] = Input$EnqueueSCMWorkflowInput.fromJson(
      (l$input as Map<String, dynamic>),
    );
    return Variables$Mutation$EnqueueScmWorkflow._(result$data);
  }

  Map<String, dynamic> _$data;

  Input$EnqueueSCMWorkflowInput get input =>
      (_$data['input'] as Input$EnqueueSCMWorkflowInput);
  ...
  CopyWith$Variables$Mutation$EnqueueScmWorkflow<
    Variables$Mutation$EnqueueScmWorkflow
  >
  get copyWith =>
      CopyWith$Variables$Mutation$EnqueueScmWorkflow(this, (i) => i);
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Variables$Mutation$EnqueueScmWorkflow ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$input = input;
...
abstract class CopyWith$Variables$Mutation$EnqueueScmWorkflow<TRes> {
  factory CopyWith$Variables$Mutation$EnqueueScmWorkflow(
    Variables$Mutation$EnqueueScmWorkflow instance,
    TRes Function(Variables$Mutation$EnqueueScmWorkflow) then,
  ) = _CopyWithImpl$Variables$Mutation$EnqueueScmWorkflow;

  factory CopyWith$Variables$Mutation$EnqueueScmWorkflow.stub(TRes res) =
      _CopyWithStubImpl$Variables$Mutation$EnqueueScmWorkflow;

  TRes call({Input$EnqueueSCMWorkflowInput? input});
}

class _CopyWithImpl$Variables$Mutation$EnqueueScmWorkflow<TRes>
    implements CopyWith$Variables$Mutation$EnqueueScmWorkflow<TRes> {
  _CopyWithImpl$Variables$Mutation$EnqueueScmWorkflow(
    this._instance,
    this._then,
  );

  final Variables$Mutation$EnqueueScmWorkflow _instance;

  final TRes Function(Variables$Mutation$EnqueueScmWorkflow) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({Object? input = _undefined}) => _then(
    Variables$Mutation$EnqueueScmWorkflow._({
      ..._instance._$data,
      if (input != _undefined && input != null)
        'input': (input as Input$EnqueueSCMWorkflowInput),
    }),
  );
}

class _CopyWithStubImpl$Variables$Mutation$EnqueueScmWorkflow<TRes>
    implements CopyWith$Variables$Mutation$EnqueueScmWorkflow<TRes> {
  _CopyWithStubImpl$Variables$Mutation$EnqueueScmWorkflow(this._res);

  TRes _res;

  call({Input$EnqueueSCMWorkflowInput? input}) => _res;
}

class Mutation$EnqueueScmWorkflow {
  Mutation$EnqueueScmWorkflow({
    required this.enqueueScmWorkflow,
    this.$__typename = 'Mutation',
  });

  factory Mutation$EnqueueScmWorkflow.fromJson(Map<String, dynamic> json) {
    final l$enqueueScmWorkflow = json['enqueueScmWorkflow'];
    final l$$__typename = json['__typename'];
    return Mutation$EnqueueScmWorkflow(
      enqueueScmWorkflow:
          Mutation$EnqueueScmWorkflow$enqueueScmWorkflow.fromJson(
            (l$enqueueScmWorkflow as Map<String, dynamic>),
          ),
      $__typename: (l$$__typename as String),
    );
  }

  final Mutation$EnqueueScmWorkflow$enqueueScmWorkflow enqueueScmWorkflow;

  final String $__typename;

  Map<String, dynamic> toJson() {
    final _resultData = <String, dynamic>{};
    final l$enqueueScmWorkflow = enqueueScmWorkflow;
    _resultData['enqueueScmWorkflow'] = l$enqueueScmWorkflow.toJson();
    final l$$__typename = $__typename;
    _resultData['__typename'] = l$$__typename;
    return _resultData;
  }
  ...
  int get hashCode {
    final l$enqueueScmWorkflow = enqueueScmWorkflow;
    final l$$__typename = $__typename;
    return Object.hashAll([l$enqueueScmWorkflow, l$$__typename]);
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$EnqueueScmWorkflow ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$enqueueScmWorkflow = enqueueScmWorkflow;
    final lOther$enqueueScmWorkflow = other.enqueueScmWorkflow;
    if (l$enqueueScmWorkflow != lOther$enqueueScmWorkflow) {
      return false;
    }
    final l$$__typename = $__typename;
    final lOther$$__typename = other.$__typename;
...
extension UtilityExtension$Mutation$EnqueueScmWorkflow
    on Mutation$EnqueueScmWorkflow {
  CopyWith$Mutation$EnqueueScmWorkflow<Mutation$EnqueueScmWorkflow>
  get copyWith => CopyWith$Mutation$EnqueueScmWorkflow(this, (i) => i);
}

abstract class CopyWith$Mutation$EnqueueScmWorkflow<TRes> {
  factory CopyWith$Mutation$EnqueueScmWorkflow(
    Mutation$EnqueueScmWorkflow instance,
    TRes Function(Mutation$EnqueueScmWorkflow) then,
  ) = _CopyWithImpl$Mutation$EnqueueScmWorkflow;

  factory CopyWith$Mutation$EnqueueScmWorkflow.stub(TRes res) =
      _CopyWithStubImpl$Mutation$EnqueueScmWorkflow;

  TRes call({
    Mutation$EnqueueScmWorkflow$enqueueScmWorkflow? enqueueScmWorkflow,
    String? $__typename,
  });
  CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow<TRes>
  get enqueueScmWorkflow;
}

class _CopyWithImpl$Mutation$EnqueueScmWorkflow<TRes>
    implements CopyWith$Mutation$EnqueueScmWorkflow<TRes> {
  _CopyWithImpl$Mutation$EnqueueScmWorkflow(this._instance, this._then);

  final Mutation$EnqueueScmWorkflow _instance;

  final TRes Function(Mutation$EnqueueScmWorkflow) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({
    Object? enqueueScmWorkflow = _undefined,
    Object? $__typename = _undefined,
  }) => _then(
    Mutation$EnqueueScmWorkflow(
      enqueueScmWorkflow:
          enqueueScmWorkflow == _undefined || enqueueScmWorkflow == null
          ? _instance.enqueueScmWorkflow
          : (enqueueScmWorkflow
                as Mutation$EnqueueScmWorkflow$enqueueScmWorkflow),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow<TRes>
  get enqueueScmWorkflow {
    final local$enqueueScmWorkflow = _instance.enqueueScmWorkflow;
    return CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow(
      local$enqueueScmWorkflow,
      (e) => call(enqueueScmWorkflow: e),
    );
  }
}

class _CopyWithStubImpl$Mutation$EnqueueScmWorkflow<TRes>
    implements CopyWith$Mutation$EnqueueScmWorkflow<TRes> {
  _CopyWithStubImpl$Mutation$EnqueueScmWorkflow(this._res);
  ...
  CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow<TRes>
  get enqueueScmWorkflow =>
      CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow.stub(_res);
}

const documentNodeMutationEnqueueScmWorkflow = DocumentNode(
  definitions: [
    OperationDefinitionNode(
      type: OperationType.mutation,
      name: NameNode(value: 'EnqueueScmWorkflow'),
      variableDefinitions: [
        VariableDefinitionNode(
            ...
            selectionSet: SelectionSetNode(
              selections: [
                ...
                InlineFragmentNode(
                  typeCondition: TypeConditionNode(
                    on: NamedTypeNode(
                      name: NameNode(value: 'EnqueueSCMWorkflowSuccess'),
                      isNonNull: false,
                    ),
                  ),
                  directives: [],
...
Mutation$EnqueueScmWorkflow _parserFn$Mutation$EnqueueScmWorkflow(
  Map<String, dynamic> data,
) => Mutation$EnqueueScmWorkflow.fromJson(data);
typedef OnMutationCompleted$Mutation$EnqueueScmWorkflow =
    FutureOr<void> Function(
      Map<String, dynamic>?,
      Mutation$EnqueueScmWorkflow?,
    );

class Options$Mutation$EnqueueScmWorkflow
    extends graphql.MutationOptions<Mutation$EnqueueScmWorkflow> {
  Options$Mutation$EnqueueScmWorkflow({
    String? operationName,
    required Variables$Mutation$EnqueueScmWorkflow variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    Mutation$EnqueueScmWorkflow? typedOptimisticResult,
    graphql.Context? context,
    OnMutationCompleted$Mutation$EnqueueScmWorkflow? onCompleted,
    graphql.OnMutationUpdate<Mutation$EnqueueScmWorkflow>? update,
       ...
       super(
         ...
         onCompleted: onCompleted == null
             ...
             : (data) => onCompleted(
                 ...
                 data == null
                     ? null
                     : _parserFn$Mutation$EnqueueScmWorkflow(data),
               ),
         update: update,
         onError: onError,
         document: documentNodeMutationEnqueueScmWorkflow,
         parserFn: _parserFn$Mutation$EnqueueScmWorkflow,
       );

  final OnMutationCompleted$Mutation$EnqueueScmWorkflow? onCompletedWithParsed;
...
class WatchOptions$Mutation$EnqueueScmWorkflow
    extends graphql.WatchQueryOptions<Mutation$EnqueueScmWorkflow> {
  WatchOptions$Mutation$EnqueueScmWorkflow({
    String? operationName,
    required Variables$Mutation$EnqueueScmWorkflow variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
...
extension ClientExtension$Mutation$EnqueueScmWorkflow on graphql.GraphQLClient {
  Future<graphql.QueryResult<Mutation$EnqueueScmWorkflow>>
  mutate$EnqueueScmWorkflow(
    Options$Mutation$EnqueueScmWorkflow options,
  ) async => await this.mutate(options);

  graphql.ObservableQuery<Mutation$EnqueueScmWorkflow>
  watchMutation$EnqueueScmWorkflow(
    WatchOptions$Mutation$EnqueueScmWorkflow options,
  ) => this.watchMutation(options);
}

class Mutation$EnqueueScmWorkflow$enqueueScmWorkflow {
  Mutation$EnqueueScmWorkflow$enqueueScmWorkflow({required this.$__typename});

  factory Mutation$EnqueueScmWorkflow$enqueueScmWorkflow.fromJson(
    Map<String, dynamic> json,
  ) {
    switch (json["__typename"] as String) {
      case "EnqueueSCMWorkflowSuccess":
        return Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess.fromJson(
          json,
        );

      case "GraphError":
        return Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError.fromJson(
          json,
        );

      default:
        final l$$__typename = json['__typename'];
        return Mutation$EnqueueScmWorkflow$enqueueScmWorkflow(
          $__typename: (l$$__typename as String),
        );
    }
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$EnqueueScmWorkflow$enqueueScmWorkflow ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$$__typename = $__typename;
...
extension UtilityExtension$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow
    on Mutation$EnqueueScmWorkflow$enqueueScmWorkflow {
  CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow<
    Mutation$EnqueueScmWorkflow$enqueueScmWorkflow
  >
  get copyWith =>
      CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow(this, (i) => i);

  _T when<_T>({
    required _T Function(
      Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess,
    )
    enqueueSCMWorkflowSuccess,
    required _T Function(
      Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError,
    )
    graphError,
    required _T Function() orElse,
  }) {
    switch ($__typename) {
      case "EnqueueSCMWorkflowSuccess":
        return enqueueSCMWorkflowSuccess(
          this
              as Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess,
        );

      case "GraphError":
        return graphError(
          this as Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError,
        );
  ...
  _T maybeWhen<_T>({
    ...
    enqueueSCMWorkflowSuccess,
    _T Function(Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError)?
    graphError,
    required _T Function() orElse,
  }) {
    switch ($__typename) {
      case "EnqueueSCMWorkflowSuccess":
        if (enqueueSCMWorkflowSuccess != null) {
          return enqueueSCMWorkflowSuccess(
            this
                as Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess,
          );
...
abstract class CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow<TRes> {
  factory CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow(
    Mutation$EnqueueScmWorkflow$enqueueScmWorkflow instance,
    TRes Function(Mutation$EnqueueScmWorkflow$enqueueScmWorkflow) then,
  ) = _CopyWithImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow;

  factory CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow.stub(
    TRes res,
  ) = _CopyWithStubImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow;

  TRes call({String? $__typename});
}

class _CopyWithImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow<TRes>
    implements CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow<TRes> {
  _CopyWithImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow(
    this._instance,
    this._then,
  );

  final Mutation$EnqueueScmWorkflow$enqueueScmWorkflow _instance;

  final TRes Function(Mutation$EnqueueScmWorkflow$enqueueScmWorkflow) _then;
...
class _CopyWithStubImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow<TRes>
    implements CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow<TRes> {
  _CopyWithStubImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow(this._res);
...
class Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess
    implements Mutation$EnqueueScmWorkflow$enqueueScmWorkflow {
  Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess({
    required this.queueTaskID,
    required this.duplicate,
    this.$__typename = 'EnqueueSCMWorkflowSuccess',
  });

  factory Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$queueTaskID = json['queueTaskID'];
    final l$duplicate = json['duplicate'];
    final l$$__typename = json['__typename'];
    return Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess(
      queueTaskID: (l$queueTaskID as String),
      duplicate: (l$duplicate as bool),
      $__typename: (l$$__typename as String),
    );
  ...
  int get hashCode {
    ...
    final l$duplicate = duplicate;
    final l$$__typename = $__typename;
    return Object.hashAll([l$queueTaskID, l$duplicate, l$$__typename]);
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$queueTaskID = queueTaskID;
...
extension UtilityExtension$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess
    on Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess {
  CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess<
    Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess
  >
  get copyWith =>
      CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess(
...
abstract class CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess<
  TRes
> {
  factory CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess(
    Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess
    instance,
    TRes Function(
      Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess,
    ...
    then,
  ) = _CopyWithImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess;

  factory CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess.stub(
    TRes res,
  ) = _CopyWithStubImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess;

  TRes call({String? queueTaskID, bool? duplicate, String? $__typename});
}

class _CopyWithImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess<
  TRes
>
    implements
        CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess<
  ...
  final Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess
  _instance;
...
class _CopyWithStubImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess<
  TRes
>
    implements
        CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$EnqueueSCMWorkflowSuccess<
  ...
  call({String? queueTaskID, bool? duplicate, String? $__typename}) => _res;
}

class Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError
    implements Mutation$EnqueueScmWorkflow$enqueueScmWorkflow {
  Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError({
    required this.code,
    required this.message,
  ...
  factory Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$code = json['code'];
    final l$message = json['message'];
    final l$field = json['field'];
    final l$$__typename = json['__typename'];
    return Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError(
      code: fromJson$Enum$GraphErrorCode((l$code as String)),
      message: (l$message as String),
      field: (l$field as String?),
      $__typename: (l$$__typename as String),
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$code = code;
...
extension UtilityExtension$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError
    on Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError {
  CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError<
    Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError
  >
  get copyWith =>
      CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError(
...
abstract class CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError<
  TRes
> {
  factory CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError(
    Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError instance,
    TRes Function(Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError)
    then,
  ) = _CopyWithImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError;

  factory CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError.stub(
    TRes res,
  ) = _CopyWithStubImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError;
...
class _CopyWithImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError<
  TRes
>
    implements
        CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError<
  ...
  final Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError _instance;
...
class _CopyWithStubImpl$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError<
  TRes
>
    implements
        CopyWith$Mutation$EnqueueScmWorkflow$enqueueScmWorkflow$$GraphError<
...
class Variables$Mutation$EnqueueIngestionWorkflow {
  factory Variables$Mutation$EnqueueIngestionWorkflow({
    required Input$EnqueueIngestionWorkflowInput input,
  }) => Variables$Mutation$EnqueueIngestionWorkflow._({r'input': input});

  Variables$Mutation$EnqueueIngestionWorkflow._(this._$data);

  factory Variables$Mutation$EnqueueIngestionWorkflow.fromJson(
    Map<String, dynamic> data,
  ) {
    final result$data = <String, dynamic>{};
    final l$input = data['input'];
    result$data['input'] = Input$EnqueueIngestionWorkflowInput.fromJson(
      (l$input as Map<String, dynamic>),
    );
    return Variables$Mutation$EnqueueIngestionWorkflow._(result$data);
  }

  Map<String, dynamic> _$data;

  Input$EnqueueIngestionWorkflowInput get input =>
      (_$data['input'] as Input$EnqueueIngestionWorkflowInput);
  ...
  CopyWith$Variables$Mutation$EnqueueIngestionWorkflow<
    Variables$Mutation$EnqueueIngestionWorkflow
  >
  get copyWith =>
      CopyWith$Variables$Mutation$EnqueueIngestionWorkflow(this, (i) => i);
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Variables$Mutation$EnqueueIngestionWorkflow ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$input = input;
...
abstract class CopyWith$Variables$Mutation$EnqueueIngestionWorkflow<TRes> {
  factory CopyWith$Variables$Mutation$EnqueueIngestionWorkflow(
    Variables$Mutation$EnqueueIngestionWorkflow instance,
    TRes Function(Variables$Mutation$EnqueueIngestionWorkflow) then,
  ) = _CopyWithImpl$Variables$Mutation$EnqueueIngestionWorkflow;

  factory CopyWith$Variables$Mutation$EnqueueIngestionWorkflow.stub(TRes res) =
      _CopyWithStubImpl$Variables$Mutation$EnqueueIngestionWorkflow;

  TRes call({Input$EnqueueIngestionWorkflowInput? input});
}

class _CopyWithImpl$Variables$Mutation$EnqueueIngestionWorkflow<TRes>
    implements CopyWith$Variables$Mutation$EnqueueIngestionWorkflow<TRes> {
  _CopyWithImpl$Variables$Mutation$EnqueueIngestionWorkflow(
    this._instance,
    this._then,
  );

  final Variables$Mutation$EnqueueIngestionWorkflow _instance;

  final TRes Function(Variables$Mutation$EnqueueIngestionWorkflow) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({Object? input = _undefined}) => _then(
    Variables$Mutation$EnqueueIngestionWorkflow._({
      ..._instance._$data,
      if (input != _undefined && input != null)
        'input': (input as Input$EnqueueIngestionWorkflowInput),
    }),
  );
}

class _CopyWithStubImpl$Variables$Mutation$EnqueueIngestionWorkflow<TRes>
    implements CopyWith$Variables$Mutation$EnqueueIngestionWorkflow<TRes> {
  _CopyWithStubImpl$Variables$Mutation$EnqueueIngestionWorkflow(this._res);

  TRes _res;

  call({Input$EnqueueIngestionWorkflowInput? input}) => _res;
}

class Mutation$EnqueueIngestionWorkflow {
  Mutation$EnqueueIngestionWorkflow({
    required this.enqueueIngestionWorkflow,
    this.$__typename = 'Mutation',
  });

  factory Mutation$EnqueueIngestionWorkflow.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$enqueueIngestionWorkflow = json['enqueueIngestionWorkflow'];
    final l$$__typename = json['__typename'];
    return Mutation$EnqueueIngestionWorkflow(
      enqueueIngestionWorkflow:
          Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow.fromJson(
            (l$enqueueIngestionWorkflow as Map<String, dynamic>),
          ),
      $__typename: (l$$__typename as String),
    );
  }

  final Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow
  enqueueIngestionWorkflow;
  ...
  Map<String, dynamic> toJson() {
    final _resultData = <String, dynamic>{};
    final l$enqueueIngestionWorkflow = enqueueIngestionWorkflow;
    _resultData['enqueueIngestionWorkflow'] = l$enqueueIngestionWorkflow
        .toJson();
    final l$$__typename = $__typename;
    _resultData['__typename'] = l$$__typename;
    return _resultData;
  ...
  int get hashCode {
    final l$enqueueIngestionWorkflow = enqueueIngestionWorkflow;
    final l$$__typename = $__typename;
    return Object.hashAll([l$enqueueIngestionWorkflow, l$$__typename]);
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$EnqueueIngestionWorkflow ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$enqueueIngestionWorkflow = enqueueIngestionWorkflow;
    final lOther$enqueueIngestionWorkflow = other.enqueueIngestionWorkflow;
    if (l$enqueueIngestionWorkflow != lOther$enqueueIngestionWorkflow) {
      return false;
    }
    final l$$__typename = $__typename;
    final lOther$$__typename = other.$__typename;
...
extension UtilityExtension$Mutation$EnqueueIngestionWorkflow
    on Mutation$EnqueueIngestionWorkflow {
  CopyWith$Mutation$EnqueueIngestionWorkflow<Mutation$EnqueueIngestionWorkflow>
  get copyWith => CopyWith$Mutation$EnqueueIngestionWorkflow(this, (i) => i);
}

abstract class CopyWith$Mutation$EnqueueIngestionWorkflow<TRes> {
  factory CopyWith$Mutation$EnqueueIngestionWorkflow(
    Mutation$EnqueueIngestionWorkflow instance,
    TRes Function(Mutation$EnqueueIngestionWorkflow) then,
  ) = _CopyWithImpl$Mutation$EnqueueIngestionWorkflow;

  factory CopyWith$Mutation$EnqueueIngestionWorkflow.stub(TRes res) =
      _CopyWithStubImpl$Mutation$EnqueueIngestionWorkflow;

  TRes call({
    Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow?
    enqueueIngestionWorkflow,
    String? $__typename,
  });
  CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow<TRes>
  get enqueueIngestionWorkflow;
}

class _CopyWithImpl$Mutation$EnqueueIngestionWorkflow<TRes>
    implements CopyWith$Mutation$EnqueueIngestionWorkflow<TRes> {
  _CopyWithImpl$Mutation$EnqueueIngestionWorkflow(this._instance, this._then);

  final Mutation$EnqueueIngestionWorkflow _instance;

  final TRes Function(Mutation$EnqueueIngestionWorkflow) _then;

  static const _undefined = <dynamic, dynamic>{};

  TRes call({
    Object? enqueueIngestionWorkflow = _undefined,
    Object? $__typename = _undefined,
  }) => _then(
    Mutation$EnqueueIngestionWorkflow(
      enqueueIngestionWorkflow:
          enqueueIngestionWorkflow == _undefined ||
              enqueueIngestionWorkflow == null
          ? _instance.enqueueIngestionWorkflow
          : (enqueueIngestionWorkflow
                as Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow),
      $__typename: $__typename == _undefined || $__typename == null
          ? _instance.$__typename
          : ($__typename as String),
    ),
  ...
  CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow<TRes>
  get enqueueIngestionWorkflow {
    final local$enqueueIngestionWorkflow = _instance.enqueueIngestionWorkflow;
    return CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow(
      local$enqueueIngestionWorkflow,
      (e) => call(enqueueIngestionWorkflow: e),
    );
  }
}

class _CopyWithStubImpl$Mutation$EnqueueIngestionWorkflow<TRes>
    implements CopyWith$Mutation$EnqueueIngestionWorkflow<TRes> {
  _CopyWithStubImpl$Mutation$EnqueueIngestionWorkflow(this._res);
  ...
  CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow<TRes>
  get enqueueIngestionWorkflow =>
      CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow.stub(
        _res,
      );
}

const documentNodeMutationEnqueueIngestionWorkflow = DocumentNode(
  definitions: [
    OperationDefinitionNode(
      type: OperationType.mutation,
      name: NameNode(value: 'EnqueueIngestionWorkflow'),
      variableDefinitions: [
        VariableDefinitionNode(
          variable: VariableNode(name: NameNode(value: 'input')),
          type: NamedTypeNode(
            name: NameNode(value: 'EnqueueIngestionWorkflowInput'),
            isNonNull: true,
          ),
          defaultValue: DefaultValueNode(value: null),
          directives: [],
            ...
            selectionSet: SelectionSetNode(
              selections: [
                ...
                InlineFragmentNode(
                  typeCondition: TypeConditionNode(
                    on: NamedTypeNode(
                      name: NameNode(value: 'EnqueueIngestionWorkflowSuccess'),
                      isNonNull: false,
                    ),
                  ),
                  directives: [],
...
Mutation$EnqueueIngestionWorkflow _parserFn$Mutation$EnqueueIngestionWorkflow(
  Map<String, dynamic> data,
) => Mutation$EnqueueIngestionWorkflow.fromJson(data);
typedef OnMutationCompleted$Mutation$EnqueueIngestionWorkflow =
    FutureOr<void> Function(
      Map<String, dynamic>?,
      Mutation$EnqueueIngestionWorkflow?,
    );

class Options$Mutation$EnqueueIngestionWorkflow
    extends graphql.MutationOptions<Mutation$EnqueueIngestionWorkflow> {
  Options$Mutation$EnqueueIngestionWorkflow({
    String? operationName,
    required Variables$Mutation$EnqueueIngestionWorkflow variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
    graphql.CacheRereadPolicy? cacheRereadPolicy,
    Object? optimisticResult,
    Mutation$EnqueueIngestionWorkflow? typedOptimisticResult,
    graphql.Context? context,
    OnMutationCompleted$Mutation$EnqueueIngestionWorkflow? onCompleted,
    graphql.OnMutationUpdate<Mutation$EnqueueIngestionWorkflow>? update,
    graphql.OnError? onError,
  }) : onCompletedWithParsed = onCompleted,
       super(
         variables: variables.toJson(),
         ...
         onCompleted: onCompleted == null
             ...
             : (data) => onCompleted(
                 ...
                 data == null
                     ? null
                     : _parserFn$Mutation$EnqueueIngestionWorkflow(data),
               ),
         update: update,
         onError: onError,
         document: documentNodeMutationEnqueueIngestionWorkflow,
         parserFn: _parserFn$Mutation$EnqueueIngestionWorkflow,
       );

  final OnMutationCompleted$Mutation$EnqueueIngestionWorkflow?
  onCompletedWithParsed;
...
class WatchOptions$Mutation$EnqueueIngestionWorkflow
    extends graphql.WatchQueryOptions<Mutation$EnqueueIngestionWorkflow> {
  WatchOptions$Mutation$EnqueueIngestionWorkflow({
    String? operationName,
    required Variables$Mutation$EnqueueIngestionWorkflow variables,
    graphql.FetchPolicy? fetchPolicy,
    graphql.ErrorPolicy? errorPolicy,
...
extension ClientExtension$Mutation$EnqueueIngestionWorkflow
    on graphql.GraphQLClient {
  Future<graphql.QueryResult<Mutation$EnqueueIngestionWorkflow>>
  mutate$EnqueueIngestionWorkflow(
    Options$Mutation$EnqueueIngestionWorkflow options,
  ) async => await this.mutate(options);

  graphql.ObservableQuery<Mutation$EnqueueIngestionWorkflow>
  watchMutation$EnqueueIngestionWorkflow(
    WatchOptions$Mutation$EnqueueIngestionWorkflow options,
  ) => this.watchMutation(options);
}

class Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow {
  Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow({
    required this.$__typename,
  });

  factory Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow.fromJson(
    Map<String, dynamic> json,
  ) {
    switch (json["__typename"] as String) {
      case "EnqueueIngestionWorkflowSuccess":
        return Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess.fromJson(
          json,
        );

      case "GraphError":
        return Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError.fromJson(
          json,
        );

      default:
        final l$$__typename = json['__typename'];
        return Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow(
          $__typename: (l$$__typename as String),
        );
    }
  }
  ...
  bool operator ==(Object other) {
    ...
    if (other is! Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$$__typename = $__typename;
...
extension UtilityExtension$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow
    on Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow {
  CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow<
    Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow
  >
  get copyWith =>
      CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow(
  ...
  _T when<_T>({
    required _T Function(
      Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess,
    )
    enqueueIngestionWorkflowSuccess,
    required _T Function(
      Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError,
    )
    graphError,
    required _T Function() orElse,
  }) {
    switch ($__typename) {
      case "EnqueueIngestionWorkflowSuccess":
        return enqueueIngestionWorkflowSuccess(
          this
              as Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess,
        );

      case "GraphError":
        return graphError(
          this
              as Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError,
        );
  ...
  _T maybeWhen<_T>({
    ...
    switch ($__typename) {
      case "EnqueueIngestionWorkflowSuccess":
        if (enqueueIngestionWorkflowSuccess != null) {
          return enqueueIngestionWorkflowSuccess(
            this
                as Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess,
          );
...
abstract class CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow<
  TRes
> {
  factory CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow(
    Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow instance,
    TRes Function(Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow)
    then,
  ) = _CopyWithImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow;

  factory CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow.stub(
    TRes res,
  ) = _CopyWithStubImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow;

  TRes call({String? $__typename});
}

class _CopyWithImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow<
  TRes
>
    implements
        CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow<
  ...
  final Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow _instance;
...
class _CopyWithStubImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow<
  TRes
>
    implements
        CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow<
...
class Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess
    implements Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow {
  Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess({
    required this.queueTaskID,
    required this.duplicate,
    this.$__typename = 'EnqueueIngestionWorkflowSuccess',
  });

  factory Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$queueTaskID = json['queueTaskID'];
    final l$duplicate = json['duplicate'];
    final l$$__typename = json['__typename'];
    return Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess(
      queueTaskID: (l$queueTaskID as String),
      duplicate: (l$duplicate as bool),
      $__typename: (l$$__typename as String),
    );
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$queueTaskID = queueTaskID;
...
extension UtilityExtension$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess
    on
        Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess {
  CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess<
    Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess
  >
  get copyWith =>
      CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess(
...
abstract class CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess<
  TRes
> {
  factory CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess(
    Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess
    instance,
    TRes Function(
      Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess,
    ...
    then,
  ) = _CopyWithImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess;

  factory CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess.stub(
    TRes res,
  ) = _CopyWithStubImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess;

  TRes call({String? queueTaskID, bool? duplicate, String? $__typename});
}

class _CopyWithImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess<
  TRes
>
    implements
        CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess<
  ...
  final Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess
  _instance;
...
class _CopyWithStubImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess<
  TRes
>
    implements
        CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$EnqueueIngestionWorkflowSuccess<
...
class Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError
    implements Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow {
  Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError({
    required this.code,
    required this.message,
  ...
  factory Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError.fromJson(
    Map<String, dynamic> json,
  ) {
    final l$code = json['code'];
    final l$message = json['message'];
    final l$field = json['field'];
    final l$$__typename = json['__typename'];
    return Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError(
      code: fromJson$Enum$GraphErrorCode((l$code as String)),
      message: (l$message as String),
      field: (l$field as String?),
      $__typename: (l$$__typename as String),
  ...
  bool operator ==(Object other) {
    ...
    if (other
            is! Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError ||
        runtimeType != other.runtimeType) {
      return false;
    }
    final l$code = code;
...
extension UtilityExtension$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError
    on Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError {
  CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError<
    Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError
  >
  get copyWith =>
      CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError(
...
abstract class CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError<
  TRes
> {
  factory CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError(
    Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError
    instance,
    TRes Function(
      Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError,
    ...
    then,
  ) = _CopyWithImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError;

  factory CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError.stub(
    TRes res,
  ) = _CopyWithStubImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError;
...
class _CopyWithImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError<
  TRes
>
    implements
        CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError<
  ...
  final Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError
  _instance;
...
class _CopyWithStubImpl$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError<
  TRes
>
    implements
        CopyWith$Mutation$EnqueueIngestionWorkflow$enqueueIngestionWorkflow$$GraphError<
